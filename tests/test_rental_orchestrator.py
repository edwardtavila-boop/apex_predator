"""
APEX PREDATOR  //  tests.test_rental_orchestrator
=================================================
...
from apex_predator.rental.orchestrator import (
    InstanceState,
    MultiTenantOrchestrator,
    TenantContainerSpec,
)
from apex_predator.rental.tenancy import (
    ApiKeyRecord,
    TenantStatus,
    build_active_tenant,
)
from apex_predator.rental.tiers import BotSku, RentalTier
...
def test_reconcile_replaces_stored_specs_on_tier_downgrade() -> None:
    ...
    from apex_predator.rental.tenancy import entitlement_from_tier
    from apex_predator.rental.tiers import STARTER as STARTER_TIER
...
def test_container_spec_defaults() -> None:
    ...
    assert spec.image == "apexpredator/bot:current"
