"""APEX PREDATOR  //  scripts._chaos_drill_matrix.
...
::
    ...
    python -m apex_predator.scripts._chaos_drill_matrix
...
def render_markdown(report: CoverageReport) -> str:
    ...
    lines: list[str] = []
    lines.append("# APEX PREDATOR // Chaos Drill Coverage Matrix")
    lines.append("")
    lines.append(
