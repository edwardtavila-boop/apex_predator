...
class PrecedentGraph:
    ...
    def query(self, key: PrecedentKey) -> PrecedentQuery:
        ...
        wr = sum(e.outcome_correct for e in labeled if e.outcome_correct) / len(labeled) \
    ...
    def keys(self) -> list[PrecedentKey]:
        ...
        for k in self._store:
            out.append(PrecedentKey(
                regime=k[0], session_phase=k[1],
                event_category=k[2], binding_constraint=k[3],
            ))
        return out
