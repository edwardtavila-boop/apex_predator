"""
APEX PREDATOR  //  brain.avengers.batman
========================================
...
from apex_predator.brain.avengers.base import Persona, PersonaId
...
class Batman(Persona):
    ...
    def _system_prompt(self, envelope: TaskEnvelope) -> str:
        return (
            "You are BATMAN -- the APEX PREDATOR adversarial architect.\n"
