...
from apex_predator.brain.jarvis_v3.claude_layer.stakes import StakesInputs
...
def _ctx(**overrides) -> StructuredContext:
    base = dict(
        ...
        doctrine_net_bias=-0.1, doctrine_tenets=["CAPITAL_FIRST"],
        precedent_n=10, precedent_win_rate=0.6, precedent_mean_r=0.5,
        anomaly_flags=[], operator_overrides_24h=1,
...
class TestAvengersDispatch:
    ...
    def test_crisis_triggers_batman(self):
        ...
        result = dispatch.decide(
            escalation_inputs=EscalationInputs(
                regime="CRISIS", stress_composite=0.7, precedent_n=10,
            ),
    ...
    def test_quota_freeze_returns_jarvis_freeze(self):
        ...
        u.record_call(ClaudeCallResult(
...
class TestBackgroundTaskRouting:
    ...
    def test_hot_path_tasks_are_short_cadence(self):
        ...
        hot = (BackgroundTask.SHADOW_TICK, BackgroundTask.DRIFT_SUMMARY,
