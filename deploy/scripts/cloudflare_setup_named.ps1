...
#
# Usage:
#   .\cloudflare_setup_named.ps1 -Domain apexpredator.live -Hostname jarvis
#   .\cloudflare_setup_named.ps1 -Domain apexpredator.live -Hostname jarvis -ApiToken <tok>
# ============================================================================
[CmdletBinding()]
param(
    ...
    [int]$LocalPort = 8000,
    [string]$TunnelName = "apex-predator",
...
logfile: $env:LOCALAPPDATA\apex_predator\logs\cloudflare-tunnel.log
no-autoupdate: true
ingress:
  - hostname: $fqdn
