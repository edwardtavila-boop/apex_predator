...
def main() -> int:
    ...
    from apex_predator.brain.avengers import AvengersDispatch, Fleet
    from apex_predator.brain.avengers.base import DryRunExecutor
    from apex_predator.brain.jarvis_v3.claude_layer.cost_governor import CostGovernor
    from apex_predator.brain.jarvis_v3.claude_layer.escalation import EscalationInputs
    ...
    from apex_predator.brain.jarvis_v3.claude_layer.usage_tracker import UsageTracker
    ...
    state_dir = Path(os.environ.get("LOCALAPPDATA", str(Path.home()))) / "apex_predator" / "state"
