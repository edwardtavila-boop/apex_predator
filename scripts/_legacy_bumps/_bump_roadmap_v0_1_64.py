...
----------------
  ...
  * The supervisor (run_apex_live.py) is unchanged. Callers that want
...
----------------------
  ...
  * apex_predator_tests_passing updated to 3965.
  * New key apex_predator_v0_1_64_router_aware_adapter with the full
    ledger.
...
def main() -> None:
    ...
    sa["apex_predator_v0_1_64_router_aware_adapter"] = {
        "timestamp_utc": now,
        "version": VERSION,
        "bundle_name": (
        ...
        "modules_edited": [
            "apex_predator/core/broker_equity_adapter.py (new class "
            ...
            "apex_predator/tests/test_broker_equity_adapter.py (new "
        ...
        "tests_added": [
            "apex_predator/tests/test_broker_equity_adapter.py::"
        ...
        "scope_exclusions": {
            "no_supervisor_rewiring": (
                "scripts/run_apex_live.py is unchanged. The v0.1.63 "
