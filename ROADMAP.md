...
- **Indicator suite:** current apex_v3 set (ORB, EMA9/21, ATR, ADX, VWAP, Sweep+Reclaim, Bollinger MR) + additions after fine-tuning. Non-redundant, regime-aware.
...
Kill log lives at `apex_predator/docs/kill_log.json`. No bot goes live without PM signoff.
