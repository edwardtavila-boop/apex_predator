"""
APEX PREDATOR  //  tests.test_bots_mnq
======================================
...
from apex_predator.bots.base_bot import Position, RegimeType, Signal, SignalType
...
def test_sweep_reclaim_fires_on_confirmed_reclaim() -> None:
    from apex_predator.bots.base_bot import SweepResult
    bot = MnqBot()
