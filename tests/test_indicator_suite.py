"""Tests for apex_predator.brain.indicator_suite -- regime-aware weighting."""
from __future__ import annotations

import pytest

from apex_predator.brain.indicator_suite import (
    RegimeWeightProfile,
    all_profiles,
    profile_for,
...
from apex_predator.core.confluence_scorer import (
    WEIGHT_TABLE as DEFAULT_WEIGHTS,
)
from apex_predator.core.confluence_scorer import (
    score_confluence,
)
from apex_predator.features.base import FeatureResult
...
def test_score_regime_aware_restores_default_weights_after_call() -> None:
    ...
    import apex_predator.core.confluence_scorer as scorer  # noqa: PLC0415
...
def test_score_regime_aware_restores_defaults_even_on_exception(
    ...
    monkeypatch.setattr(
        "apex_predator.brain.indicator_suite.score_confluence", boom,
    )
