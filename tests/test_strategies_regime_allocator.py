"""APEX PREDATOR  //  tests.test_strategies_regime_allocator.

Unit tests for :func:`apex_predator.strategies.regime_allocator.plan_allocation`.
...
from apex_predator.funnel.waterfall import LayerId, VolRegime
