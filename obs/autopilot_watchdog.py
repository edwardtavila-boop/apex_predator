"""
APEX PREDATOR  //  obs.autopilot_watchdog
=========================================
...
if TYPE_CHECKING:
    ...
    from apex_predator.brain.jarvis_admin import ActionResponse, JarvisAdmin
    from apex_predator.obs.decision_journal import DecisionJournal
...
class AutopilotWatchdog:
    ...
    def _record_alert(self, alert: WatchdogAlert) -> None:
        ...
        from apex_predator.obs.decision_journal import (  # noqa: PLC0415
            Actor,
            Outcome,
        )
        outcome = (
