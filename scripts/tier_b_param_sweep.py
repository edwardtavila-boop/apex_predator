"""
APEX PREDATOR  //  scripts.tier_b_param_sweep
=============================================
...
Usage:
    python -m apex_predator.scripts.tier_b_param_sweep [--weeks 4] [--seed 11]
"""
...
def _run_cell(
    ...
    from apex_predator.scripts import paper_run_harness as prh
...
def main() -> int:
    ...
    print("APEX PREDATOR -- Tier-B Parameter Sweep")
    print("=" * 96)
    print(
