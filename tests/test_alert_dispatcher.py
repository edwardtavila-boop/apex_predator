...
from apex_predator.obs import alert_dispatcher as mod
from apex_predator.obs.alert_dispatcher import AlertDispatcher, _RateLimiter
    ...
    return {
        ...
        "channels": {
            ...
            "email": {
                ...
                "from": "apex-predator@thefirm.local",
            },
            "sms": {
                "enabled": False,
                "env_keys": {
