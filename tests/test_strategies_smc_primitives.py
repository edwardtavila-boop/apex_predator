"""APEX PREDATOR  //  tests.test_strategies_smc_primitives.
...
from apex_predator.strategies.models import Bar, Side
...
class TestDetectOrderBlock:
    ...
    def test_returns_none_if_no_opposing_candle(self) -> None:
        ...
        from apex_predator.strategies.smc_primitives import BreakOfStructure
