...
LIVE (explicit, double-gated)
    Requires ALL of:
      ...
      4. A Bybit venue adapter importable at ``apex_predator.venues.bybit``.
...
from apex_predator.bots.crypto_seed.bot import (  # noqa: E402
    SEED_CONFIG,
    CryptoSeedBot,
)
from apex_predator.obs.decision_journal import (  # noqa: E402
    Actor,
    DecisionJournal,
    Outcome,
)
from apex_predator.scripts.btc_paper_trade import (  # noqa: E402
    AlwaysApproveGate,
    BtcPaperRunner,
    ConfluenceFloorGate,
    PaperRouter,
...
def _bybit_adapter_available() -> bool:
    """True iff ``apex_predator.venues.bybit`` imports clean.
    ...
    try:
        ...
        importlib.import_module("apex_predator.venues.bybit")
    except ImportError:
        return False
    return True
