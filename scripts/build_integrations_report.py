"""
APEX PREDATOR  //  scripts.build_integrations_report
====================================================
...
What it does
------------
Invokes :func:`apex_predator.funnel.integrations.build_integrations_report`
...
Usage
-----
    python -m apex_predator.scripts.build_integrations_report
    python -m apex_predator.scripts.build_integrations_report \
        --out-dir docs/ \
...
from apex_predator.funnel.integrations import (  # noqa: E402
    IntegrationsReport,
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="apex_predator.scripts.build_integrations_report",
        description=(
