...
AI-OPTIMIZED APEX PREDATOR STRATEGY STACK -- SMC/ICT playbook + RL bridge.
...
(AI-Optimized Apex Predator List)" into the codebase as a pure,
composable :mod:`apex_predator.strategies` package that any bot,
...
-----------------
  ...
  * ``strategies/regime_allocator.py``
      Companion to :mod:`apex_predator.funnel.waterfall`. Where the
...
-----
  ...
  * ``tests/test_strategies_apex_policy.py``      (18 tests)
...
Reconciliation
--------------
  * apex_predator_tests_passing: 1517 -> 1620 (+103).
  ...
  * Python-only bundle. Ruff-clean across ``apex_predator/strategies/``
...
-----------------
  ...
  * Regime allocator uses :class:`LayerId` + :class:`VolRegime` from
    :mod:`apex_predator.funnel.waterfall` -- single source of truth
...
def main() -> None:
    ...
    new_tests = 1620
    sa["apex_predator_tests_passing"] = new_tests
    sa["apex_predator_tests_failing"] = 0

    sa["apex_predator_v0_1_31_ai_optimized_strategies"] = {
        "timestamp_utc": now,
        "version": "v0.1.31",
        "bundle_name": (
            "AI-OPTIMIZED APEX PREDATOR STRATEGY STACK -- "
            "SMC/ICT playbook + RL bridge"
        ),
        "directive": (
            "Absorb the founder-brief AI-Optimized Apex Predator "
        ...
        "test_files_added": [
            ...
            "tests/test_strategies_apex_policy.py",
        ...
        "tests_by_file": {
            ...
            "test_strategies_apex_policy": 18,
        ...
        "design_guarantees": {
            ...
            "ruff_clean": True,
            "guardrails_in_one_place": "_risk_mult helper in apex_policy",
    ...
    hist.append({
        "version": "v0.1.31",
        "timestamp_utc": now,
        "title": "AI-Optimized Apex Predator strategy stack",
