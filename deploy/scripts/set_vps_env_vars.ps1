...
Write-Host "  Get-ScheduledTask -TaskName 'Eta-*','ETA-*' | Stop-ScheduledTask -ErrorAction SilentlyContinue"
Write-Host "  Get-ScheduledTask -TaskName 'Eta-*','ETA-*' | Start-ScheduledTask"
