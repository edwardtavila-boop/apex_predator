...
full org-chart -- every autonomous subsystem across apex_predator,
...
-----------------
    ...
    components + one new data constant mounted into the Jarvis tab:
      ...
      - ``JARVIS_ADMIN`` constant: ``{ version, commandTree, recentAudit }``.
        * ``commandTree`` = 4 groups x 19 subsystems total:
            Bot Fleet (apex_predator): crypto_seed, eth_perp, mnq, nq.
  ...
  * Bundle metadata reconciliation in the JSX:
      ...
      - ``bundle.testCount``   180 -> 1385 (now the full apex_predator
...
def main() -> None:
    ...
    sa["apex_predator_v0_1_29_jarvis_admin_cc"] = {
        "timestamp_utc": now,
        "version": "v0.1.29",
        "bundle_name": (
        ...
        "bundle_metadata_updates": {
            ...
            "testCount": {
                ...
                "note": (
                    ...
                    "(180) to the full apex_predator suite (1385) since "
    ...
    print("  shared_artifacts.apex_predator_v0_1_29_jarvis_admin_cc written")
