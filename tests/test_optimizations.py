...
class TestMetaUpgrade:
    ...
    def test_handler_skips_when_not_a_repo(self, tmp_path, monkeypatch):
        ...
        from apex_predator.deploy.scripts.run_task import _task_meta_upgrade
...
class TestPromptWarmup:
    ...
    def test_skips_without_api_key(self, tmp_path, monkeypatch):
        ...
        from apex_predator.deploy.scripts.run_task import _task_prompt_warmup
...
class TestTelegramAdapter:
    ...
    def test_from_env_returns_none_if_unconfigured(self, monkeypatch):
        ...
        from apex_predator.deploy.scripts.telegram_alerts import TelegramAdapter
    ...
    def test_send_records_to_state(self, monkeypatch, tmp_path):
        ...
        import apex_predator.deploy.scripts.telegram_alerts as mod
...
class TestStatusPage:
    ...
    def test_index_has_expected_anchors(self):
        ...
        # Must polls our API
        assert "jarvis.apexpredator.live" in html
...
class TestSuperchargeTasks:
    ...
    def test_log_rotate_handler_writes_report(self, tmp_path):
        ...
        from apex_predator.deploy.scripts.run_task import _task_log_rotate
    ...
    def test_backup_handler_creates_archive(self, tmp_path, monkeypatch):
        ...
        from apex_predator.deploy.scripts.run_task import _task_backup
    ...
    def test_prometheus_export_handler_writes_metrics(self, tmp_path):
        ...
        from apex_predator.deploy.scripts.run_task import _task_prometheus_export
    ...
    def test_self_test_report_written(self, tmp_path, monkeypatch):
        ...
        state.mkdir()
        monkeypatch.delenv("ANTHROPIC_API_KEY", raising=False)
        from apex_predator.deploy.scripts.run_task import _task_self_test
    ...
    def test_health_watchdog_non_windows_skip(self, tmp_path, monkeypatch):
        ...
        from apex_predator.deploy.scripts.run_task import _task_health_watchdog
    ...
    def test_disk_cleanup_runs_without_error(self, tmp_path, monkeypatch):
        ...
        from apex_predator.deploy.scripts.run_task import _task_disk_cleanup
