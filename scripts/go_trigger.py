"""
APEX PREDATOR  //  scripts.go_trigger
======================================
...
Usage
-----
    python -m apex_predator.scripts.go_trigger --phrase "GO APEX MNQ LIVE-TINY"
    python -m apex_predator.scripts.go_trigger --phrase "KILL APEX NOW" --reason "BTC flash crash"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="APEX PREDATOR manual GO/KILL trigger")
    ...
    print("APEX PREDATOR  -- go_trigger")
    print("=" * 64)
