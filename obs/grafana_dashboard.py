...
Apex Predator metric names defined in :mod:`apex_predator.obs.metrics`:
...
DASHBOARD_TITLE = "APEX PREDATOR — Live Trading"
DASHBOARD_UID = "apex-predator-live"
