"""APEX PREDATOR  //  tests.test_strategies_portfolio_rebalancer.

Unit tests for :mod:`apex_predator.strategies.portfolio_rebalancer` --
...
from apex_predator.funnel.waterfall import (
    FunnelSnapshot,
    LayerId,
    LayerSnapshot,
    VolRegime,
...
class TestEndToEndComposition:
    ...
    def test_real_allocator_output_flows_through(self) -> None:
        from apex_predator.strategies.regime_allocator import (
            LayerAllocInput,
            plan_allocation,
        )
