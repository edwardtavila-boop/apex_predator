...
from apex_predator.brain.jarvis_v3.training.peak_manuals import manual_for
from apex_predator.brain.jarvis_v3.training.skills_catalog import skills_for
