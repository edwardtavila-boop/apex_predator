"""APEX PREDATOR  //  tests.test_strategies_engine_adapter.

Unit tests for :mod:`apex_predator.strategies.engine_adapter` -- the
...
from apex_predator.strategies.policy_router import RouterDecision
