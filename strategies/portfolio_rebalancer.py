"""APEX PREDATOR  //  strategies.portfolio_rebalancer.

Bridge between :mod:`apex_predator.strategies.regime_allocator` (which
produces per-layer target weights) and :mod:`apex_predator.funnel.waterfall`
...
from apex_predator.funnel.transfer import TransferRequest
from apex_predator.funnel.waterfall import LayerId, ProposedSweep

if TYPE_CHECKING:
    from apex_predator.funnel.waterfall import FunnelSnapshot
    from apex_predator.strategies.regime_allocator import AllocationPlan
