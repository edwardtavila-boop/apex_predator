"""Tests for apex_predator.core.cftc_nfa_compliance."""
from __future__ import annotations

import pytest

from apex_predator.core.cftc_nfa_compliance import (
...
def _ok_ctx(**overrides: object) -> PreTradeContext:
    ...
    base = {
        ...
        "deposit_whitelist": [],
        "apex_account_id": None,
        "other_apex_account_ids": [],
...
def test_apex_checks_skipped_when_not_apex_account() -> None:
    # No apex_account_id set -> Apex rules do not fire even if other_apex_*
