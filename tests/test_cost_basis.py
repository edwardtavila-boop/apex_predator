...
from apex_predator.tax import AccountTier, CostBasisCalculator, InstrumentType
...
class TestFIFO:
    ...
    def test_holding_days_computed(self) -> None:
        ...
        events = calc.process_sell("BTC", qty=1.0, price=50_000.0,
...
class TestSpecID:
    ...
    def test_specific_id_selection(self) -> None:
        ...
        events = calc.process_sell("ETH", qty=1.0, price=2500.0,
                                   timestamp=_ts(5), lot_id=lot_a.lot_id)
...
class TestTierIsolation:
    ...
    def test_us_and_offshore_books_independent(self) -> None:
        ...
        us_events = calc.process_sell("ETH", 1.0, 3000.0, _ts(5),
