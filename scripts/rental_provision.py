...
from apex_predator.rental import (  # noqa: E402
    BillingCycle,
    EventKind,
...
from apex_predator.rental.billing import SubscriptionStatus  # noqa: E402
from apex_predator.rental.client_contract import (  # noqa: E402
    ClientCommandKind,
    ServerMessageKind,
)
from apex_predator.rental.tenancy import (  # noqa: E402
    build_active_tenant,
)
from apex_predator.rental.tiers import price_for  # noqa: E402
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument("--ws-url", default="wss://api.apexpredator.local/ws")
...
def main(argv: list[str] | None = None) -> int:
    ...
    bundle = {
        ...
        "docs_url": "https://apexpredator.local/docs/desktop-client",
        "disclaimer": (
