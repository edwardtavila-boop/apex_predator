"""
APEX PREDATOR  //  funnel.orchestrator
======================================
...
from apex_predator.core.sweep_engine import SweepConfig, SweepResult, check_sweep
...
if TYPE_CHECKING:
    ...
    from apex_predator.funnel.waterfall import LayerId
    from apex_predator.strategies.portfolio_rebalancer import RebalancePlan
...
class FunnelOrchestrator:
    ...
    async def execute_rebalance(
        ...
        from apex_predator.strategies.portfolio_rebalancer import (
