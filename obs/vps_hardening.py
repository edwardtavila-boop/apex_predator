...
def build_systemd_unit(
    *,
    bot_user: str = "apex",
    work_dir: str = "/home/apex/apex_predator",
    entrypoint: str = "python -m apex_predator.main",
) -> str:
    """Hardened systemd unit: sandbox + restart policy."""
    return "\n".join([
        "[Unit]",
        "Description=APEX PREDATOR trading bot",
...
def build_runbook(*, operator_ip: str | None = None) -> str:
    ...
    lines = [
        "# APEX PREDATOR — VPS HARDENING RUNBOOK",
        "",
        "## 1. User setup",
