"""APEX PREDATOR  //  strategies.runtime_allowlist.
...
from apex_predator.strategies.oos_qualifier import qualify_strategies
from apex_predator.strategies.policy_router import DEFAULT_ELIGIBILITY

if TYPE_CHECKING:
    from collections.abc import Callable, Mapping

    from apex_predator.strategies.models import Bar, StrategyId
    from apex_predator.strategies.oos_qualifier import QualificationReport
