...
def main() -> None:
    ...
    sa["apex_predator_tests_passing"] = 648
    sa["apex_predator_tests_failing"] = 0

    sa["apex_predator_brain_tested"] = {
        "timestamp_utc": now,
        "modules": [
            "apex_predator/brain/regime.py",
            "apex_predator/brain/rl_agent.py",
            "apex_predator/brain/multi_agent.py",
        ],
        "tests_new": 44,
        "test_files": [
