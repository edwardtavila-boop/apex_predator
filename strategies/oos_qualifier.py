"""APEX PREDATOR  //  strategies.oos_qualifier.
...
callers (``apex_predator.bots.*``) can intersect the report against
...
from apex_predator.strategies.backtest_harness import HarnessConfig, run_harness

if TYPE_CHECKING:
    from collections.abc import Callable

    from apex_predator.strategies.apex_policy import StrategyContext
    from apex_predator.strategies.backtest_harness import (
        BacktestReport,
        StrategyTrade,
    )
