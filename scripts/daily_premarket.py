"""
APEX PREDATOR  //  scripts.daily_premarket
==========================================
...
Usage
-----
    python -m apex_predator.scripts.daily_premarket
    python -m apex_predator.scripts.daily_premarket \
...
def _render_text(ctx: JarvisContext) -> str:
    lines: list[str] = []
    lines.append("=" * 72)
    lines.append("APEX PREDATOR  //  PRE-MARKET BRIEFING  (Jarvis v2)")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="APEX PREDATOR daily pre-market briefing",
    )
