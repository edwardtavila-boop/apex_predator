...
data["shared_artifacts"]["apex_predator_tests_passing"] = 521
...
data["shared_artifacts"]["apex_predator_portfolio_risk_wired"] = {
    "timestamp_utc": "2026-04-17T05:35:00.000000+00:00",
    "modules": [
        "apex_predator/core/portfolio_risk.py",
        "apex_predator/backtest/portfolio_correlation.py",
        "apex_predator/funnel/central_dashboard.py",
    ],
    "tests_new": 35,
    "tests_total": 521,
    "ruff_green": True,
...
print("  apex_predator_tests_passing=", data["shared_artifacts"]["apex_predator_tests_passing"])
for phase in data["phases"]:
