"""APEX PREDATOR  //  backtest.synthetic_bridge.
...
from apex_predator.brain.synthetic import Bar, SyntheticBarGenerator, get_profile
from apex_predator.backtest.stress_scenarios import (
    ScenarioKind,
    ScenarioSpec,
