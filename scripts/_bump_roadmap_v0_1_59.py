...
R4 fix -- CME-calendar-aware Apex session-day
  * ``apex_predator/core/events_calendar.py`` -- new module, CME
  ...
  * ``apex_predator/core/consistency_guard.py`` -- ``apex_trading_day_iso()``
...
R3 fix -- Immutable audit log + reset acknowledgment
  * ``apex_predator/core/trailing_dd_tracker.py`` --
...
R2 fix -- Tick-cadence validator + 1s default
  * ``apex_predator/core/kill_switch_runtime.py`` --
...
R1 scaffold -- Broker-MTM equity reconciler (enforcement deferred)
  * ``apex_predator/core/broker_equity_reconciler.py`` -- new module.
...
--------------
  ...
  * ``tests/test_run_apex_live.py`` -- +4 tests
...
----------------------
  ...
  * ``apex_predator_tests_passing`` reflects the full regression
    result (3827 passed, 3 skipped as of bump time).
  * New key ``apex_predator_v0_1_59_residual_risk_closure`` with a
...
def main() -> None:
    ...
    sa["apex_predator_tests_passing"] = NEW_TESTS_ABS

    sa["apex_predator_v0_1_59_residual_risk_closure"] = {
        "timestamp_utc": now,
        "version": VERSION,
        "bundle_name": (
        ...
        "modules_added": [
            "apex_predator/core/events_calendar.py (R4: CME Globex "
            "session calendar, Good Friday via dateutil.easter + "
            "fixed-date US market closures)",
            "apex_predator/core/broker_equity_reconciler.py (R1: "
        ...
        "modules_modified": [
            "apex_predator/core/consistency_guard.py "
        ...
        "tests_added": [
            ...
            "TestAuditLogSurvivesStateDeletion, "
            "TestTrailingDDAuditLogUnit)",
            "apex_predator/tests/test_kill_switch_runtime.py "
            ...
            "apex_predator/tests/test_broker_equity_reconciler.py "
        ...
        "pre_existing_lint_debt": (
            ...
            "from v0.1.58 remains in run_apex_live.py and test "
