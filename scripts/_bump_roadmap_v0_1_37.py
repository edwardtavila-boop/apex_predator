...
-----------------
  ...
  * ``strategies/apex_policy.py`` (patch)
  ...
  * ``tests/test_strategies_regime_exclusion.py`` (~220 lines, +24 tests)
    ...
    Coverage:
      ...
      - apex_policy._risk_mult integration: HIGH_VOL/CRISIS -> 0.0,
...
Acceptance criteria
-------------------
  * ruff clean on regime_exclusion.py + apex_policy.py + new test file
  * 1795 / 1795 pytest pass (verified 2026-04-17)
  * No HIGH_VOL signal in apex_policy can produce risk_mult > 0 with
    default config
...
def main() -> None:
    ...
    sa["apex_predator_v0_1_37_high_vol_exclusion"] = {
        "timestamp_utc": now,
        "version": "v0.1.37",
        "bundle_name": (
        ...
        "theme": (
            ...
            "overfit, IS +0.216R -> OOS -0.559R) but apex_policy "
        ...
        "artifacts_added": {
            ...
            "patches": ["strategies/apex_policy.py"],
        ...
        "apex_policy_patch": {
            ...
            "import_added": (
                "from apex_predator.strategies.regime_exclusion "
