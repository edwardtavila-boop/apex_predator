"""Tests for apex_predator.scripts.setup_tradovate_secrets.
...
from apex_predator.scripts import setup_tradovate_secrets as sts
...
def test_cmd_reset_tolerates_missing_keyring(
    ...
    import apex_predator.scripts.setup_tradovate_secrets as mod
