...
JARVIS v3 // unleashed
======================
The Apex Predator Core meta-controller.
...
from apex_predator.brain.jarvis_v3.alerts_explain import AlertExplanation  # noqa: TC001  (pydantic runtime)
from apex_predator.brain.jarvis_v3.anomaly import MultiFieldDetector
from apex_predator.brain.jarvis_v3.bandit import LLMBandit
from apex_predator.brain.jarvis_v3.budget import BudgetTracker
from apex_predator.brain.jarvis_v3.calibration import (
    CalibratedVerdict,
    PlattSigmoid,
    VerdictFeatures,
    calibrate_verdict,
)
from apex_predator.brain.jarvis_v3.horizons import (
    HorizonContext,
)
from apex_predator.brain.jarvis_v3.horizons import (
    project as project_horizons,
)
from apex_predator.brain.jarvis_v3.kaizen import KaizenLedger
from apex_predator.brain.jarvis_v3.mcp_registry import MCPRegistry
from apex_predator.brain.jarvis_v3.philosophy import (
    DoctrineVerdict,
    apply_doctrine,
)
from apex_predator.brain.jarvis_v3.portfolio import (
    Exposure,
    PortfolioAssessment,
    assess_portfolio,
)
from apex_predator.brain.jarvis_v3.precedent import (
    PrecedentGraph,
    PrecedentKey,
    PrecedentQuery,
)
from apex_predator.brain.jarvis_v3.predictive import Projection, StressForecaster
from apex_predator.brain.jarvis_v3.preferences import OperatorPreferenceLearner
from apex_predator.brain.jarvis_v3.regime_stress import reweight
from apex_predator.brain.jarvis_v3.skills_registry import SkillRegistry, default_registry
