"""
APEX PREDATOR — Full Verification

Runs smoke tests across all packages, prints a pass/fail table.

Usage:
    python -m apex_predator.scripts.verify_all
"""
...
def test_core_imports() -> None:
    m = importlib.import_module("apex_predator.core")
...
def test_risk_engine_math() -> None:
    from apex_predator.core import calculate_max_leverage, fractional_kelly
...
def test_confluence_ramp() -> None:
    from apex_predator.core import score_confluence
...
def test_sweep() -> None:
    from apex_predator.core import SweepConfig, check_sweep
...
def test_bots_import() -> None:
    try:
        importlib.import_module("apex_predator.bots")
    except ImportError:
...
def test_funnel_import() -> None:
    try:
        importlib.import_module("apex_predator.funnel")
    except ImportError:
        pass
...
def test_brain_import() -> None:
    try:
        importlib.import_module("apex_predator.brain")
    except ImportError:
        pass
...
def test_staking_import() -> None:
    try:
        importlib.import_module("apex_predator.staking")
    except ImportError:
        pass
...
def test_features_import() -> None:
    try:
        importlib.import_module("apex_predator.features")
    except ImportError:
        pass
...
def test_venues_import() -> None:
    try:
        importlib.import_module("apex_predator.venues")
    except ImportError:
        pass
...
def test_backtest_import() -> None:
    try:
        importlib.import_module("apex_predator.backtest")
    except ImportError:
        pass


def test_funnel_orchestrator_flow() -> None:
    from apex_predator.funnel import FunnelOrchestrator
    assert FunnelOrchestrator is not None


def test_obs_package() -> None:
    from apex_predator.obs import (
        REGISTRY,
        Alert,
        AlertLevel,
        DiscordAlerter,
...
def test_data_package() -> None:
    from apex_predator.data import (
        DataSource,
        DatasetManifest,
        ParquetLoader,
        SlippageModel,
...
def test_walk_forward_engine() -> None:
    ...
    from apex_predator.backtest import (
        BacktestConfig,
        BarReplay,
        WalkForwardConfig,
        WalkForwardEngine,
...
def main() -> int:
    ...
    print()
    print("APEX PREDATOR -- Verification")
    print("=" * 60)
