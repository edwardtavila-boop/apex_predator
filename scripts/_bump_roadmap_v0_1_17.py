...
def main() -> None:
    ...
    sa["apex_predator_tests_passing"] = 762

    sa["apex_predator_tradovate_auth"] = {
        "timestamp_utc": now,
        "entrypoint": "apex_predator.scripts.authorize_tradovate",
        "endpoint_demo": "https://demo.tradovateapi.com/v1",
        "endpoint_live": "https://live.tradovateapi.com/v1",
        "status_artifact": "apex_predator/docs/tradovate_auth_status.json",
        "required_secrets": [
            "TRADOVATE_USERNAME",
            "TRADOVATE_PASSWORD",
            "TRADOVATE_APP_ID",
        ...
        "new_modules": [
            "apex_predator/scripts/authorize_tradovate.py",
        ],
        "modified_modules": [
            "apex_predator/venues/tradovate.py (added app_secret ctor param; "
    ...
    task["note"] = (
        "Runnable via `python -m apex_predator.scripts.authorize_tradovate`. "
    ...
    print("  shared_artifact: apex_predator_tradovate_auth added")
