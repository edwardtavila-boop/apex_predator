"""
APEX PREDATOR  //  scripts.jarvis_live
======================================
...
-----
    ...
    python -m apex_predator.scripts.jarvis_live

    # Faster cadence, bounded ticks (smoke test):
    python -m apex_predator.scripts.jarvis_live --interval 5 --max-ticks 3
...
from apex_predator.obs.jarvis_supervisor import (  # noqa: E402
    JarvisHealthReport,
    JarvisSupervisor,
    SupervisorPolicy,
)
...
if TYPE_CHECKING:
    from apex_predator.obs.alerts import MultiAlerter
...
def build_alerter_from_env() -> MultiAlerter | None:
    ...
    """
    from apex_predator.obs.alerts import (  # noqa: PLC0415
        DiscordAlerter,
        MultiAlerter,
        SlackAlerter,
        TelegramAlerter,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="APEX PREDATOR Jarvis live supervisor daemon",
    )
