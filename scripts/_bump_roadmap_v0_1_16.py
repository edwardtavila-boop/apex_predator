...
def main() -> None:
    ...
    sa["apex_predator_tests_passing"] = 752
    sa["apex_predator_tests_failing"] = 0

    sa["apex_predator_p12_polish_closed"] = {
        "timestamp_utc": now,
        "new_modules": [
            "apex_predator/core/parameter_sweep.py",
            "apex_predator/core/master_tweaks.py",
        ],
        "rewired_modules": [
            "apex_predator/tests/harness_open.py",
        ],
        "new_test_files": [
