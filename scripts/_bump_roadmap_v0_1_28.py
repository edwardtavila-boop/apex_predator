...
def main() -> None:
    ...
    sa["apex_predator_v0_1_28_jarvis_live"] = {
        "timestamp_utc": now,
        "version": "v0.1.28",
        ...
        "modules": [
            "apex_predator/obs/jarvis_supervisor.py",
            "apex_predator/scripts/jarvis_live.py",
        ],
        "supervisor": {
            "public_api": [
                "JarvisHealth",
        ...
        "daemon": {
            "entrypoint": "python -m apex_predator.scripts.jarvis_live",
