"""APEX PREDATOR  //  strategies.adaptive_sizing.
...
if TYPE_CHECKING:
    from apex_predator.strategies.models import Side, StrategyId
...
class RegimeLabel(StrEnum):
    """Wire-compatible with :mod:`strategies.apex_policy` StrategyContext.regime_label."""
...
def score_regime(
    ...
    """
    from apex_predator.strategies.models import StrategyId as _StrategyIdCls
...
def score_htf_agreement(
    ...
    from apex_predator.strategies.models import Side as _SideCls
