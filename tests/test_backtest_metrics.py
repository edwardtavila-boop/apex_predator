"""Tests for ``apex_predator.backtest.metrics``.
...
def test_import_smoke() -> None:
    ...
    importlib.import_module("apex_predator.backtest.metrics")


def test_compute_sharpe_smoke() -> None:
    """``compute_sharpe`` is callable (signature requires manual fill-in)."""
    from apex_predator.backtest.metrics import compute_sharpe
...
def test_compute_sortino_smoke() -> None:
    ...
    from apex_predator.backtest.metrics import compute_sortino
...
def test_compute_profit_factor_smoke() -> None:
    ...
    from apex_predator.backtest.metrics import compute_profit_factor
...
def test_compute_max_dd_smoke() -> None:
    ...
    from apex_predator.backtest.metrics import compute_max_dd
...
def test_compute_expectancy_smoke() -> None:
    ...
    from apex_predator.backtest.metrics import compute_expectancy
