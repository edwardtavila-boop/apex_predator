"""APEX PREDATOR  //  strategies.regime_allocator.
...
to :mod:`apex_predator.funnel.waterfall`, which owns the flow of
...
:mod:`apex_predator.funnel.waterfall` only defines LOW/NORMAL/HIGH
