"""
APEX PREDATOR  //  scripts.preflight
====================================
...
Usage:
    python -m apex_predator.scripts.preflight
"""
...
# Allow execution as both `apex_predator.scripts.preflight` (from parent)
# and `scripts.preflight` (from inside apex_predator/).
...
from apex_predator.core.session_filter import is_news_blackout  # noqa: E402
from apex_predator.obs.alerts import Alert, AlertLevel, TelegramAlerter  # noqa: E402
