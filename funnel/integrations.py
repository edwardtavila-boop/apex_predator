"""
APEX PREDATOR  //  funnel.integrations
======================================
...
def canonical_venues() -> list[VenueIntegration]:
    return [
        ...
        VenueIntegration(
            name="bybit",
            kind="perps_cex",
            module="apex_predator.venues.bybit",
        ...
        VenueIntegration(
            name="okx",
            kind="spot_cex",
            module="apex_predator.venues.okx",
            asset_classes=["spot"],
            status="READY",
        ),
        VenueIntegration(
            name="coinbase",
            kind="onramp",
            module="apex_predator.funnel.fiat_to_crypto",
        ...
        VenueIntegration(
            name="ledger_cold",
            kind="cold_wallet",
            module="apex_predator.funnel.cold_wallet_sweep",
...
def canonical_bots() -> list[BotIntegration]:
    return [
        ...
        BotIntegration(
            name="crypto_seed",
            module="apex_predator.bots.crypto_seed.crypto_seed_bot",
            venue="bybit",
        ...
        BotIntegration(
            name="eth_perp",
            module="apex_predator.bots.eth_perp.eth_perp_bot",
            venue="bybit",
        ...
        BotIntegration(
            name="sol_perp",
            module="apex_predator.bots.sol_perp.sol_perp_bot",
            venue="bybit",
            funnel_layer="LAYER_3_PERPS",
            risk_tier="CASINO",
            status="PAPER",
        ...
        BotIntegration(
            name="xrp_perp",
            module="apex_predator.bots.xrp_perp.xrp_perp_bot",
            venue="bybit",
            funnel_layer="LAYER_3_PERPS",
            risk_tier="CASINO",
            status="PAPER",
...
def canonical_staking() -> list[StakingIntegration]:
    return [
        StakingIntegration(
            protocol="Lido",
            module="apex_predator.staking.lido",
            chain="ethereum",
            asset_in="ETH",
            asset_out="wstETH",
            target_apy_pct=3.2,
        ...
        StakingIntegration(
            protocol="Jito",
            module="apex_predator.staking.jito",
            chain="solana",
            asset_in="SOL",
            asset_out="JitoSOL",
            target_apy_pct=7.5,
        ...
        StakingIntegration(
            protocol="Flare",
            module="apex_predator.staking.flare",
            chain="flare",
            asset_in="FLR",
            asset_out="sFLR",
            target_apy_pct=4.1,
        ...
        StakingIntegration(
            protocol="Ethena",
            module="apex_predator.staking.ethena",
            chain="ethereum",
            asset_in="USDT",
            asset_out="sUSDe",
            target_apy_pct=12.0,
...
def canonical_observability() -> list[ObservabilityIntegration]:
    return [
        ObservabilityIntegration(
            ...
            module="apex_predator.obs.jarvis_supervisor",
            kind="supervisor",
            status="ACTIVE",
            notes=(
        ...
        ObservabilityIntegration(
            ...
            module="apex_predator.obs.alerts.TelegramAlerter",
            kind="alerter",
            status="DRY_RUN",
        ...
        ObservabilityIntegration(
            name="DiscordAlerter",
            module="apex_predator.obs.alerts.DiscordAlerter",
            kind="alerter",
            status="DRY_RUN",
        ...
        ObservabilityIntegration(
            name="SlackAlerter",
            module="apex_predator.obs.alerts.SlackAlerter",
            kind="alerter",
            status="DRY_RUN",
        ...
        ObservabilityIntegration(
            ...
            module="apex_predator.obs.gate_override_telemetry",
            kind="telemetry",
            status="ACTIVE",
        ...
        ObservabilityIntegration(
            ...
            module="apex_predator.obs.decision_journal",
            kind="journal",
            status="ACTIVE",
        ...
        ObservabilityIntegration(
            ...
            module="apex_predator.obs.autopilot_watchdog",
            kind="supervisor",
            status="ACTIVE",
...
def render_text(report: IntegrationsReport) -> str:
    ...
    lines.append(bar)
    lines.append(
        f"APEX PREDATOR  //  INTEGRATIONS MAP  (schema v{report.schema_version})"
    )
