"""
APEX PREDATOR  //  scripts.setup_tradovate_secrets
==================================================
...
Usage
-----
    python -m apex_predator.scripts.setup_tradovate_secrets
    python -m apex_predator.scripts.setup_tradovate_secrets --check
    python -m apex_predator.scripts.setup_tradovate_secrets --reset
...
def cmd_check() -> int:
    print()
    print("APEX PREDATOR -- Tradovate secret status")
    print("=" * 60)
    missing = 0
...
def _delete(key: str) -> None:
    try:
        ...
        keyring.delete_password("apex_predator", key)
...
def cmd_interactive() -> int:
    print()
    print("APEX PREDATOR -- Tradovate secret setup")
    print("=" * 60)
    ...
    if present_now == 5:
        ...
        print("  python -m apex_predator.scripts.authorize_tradovate")
        return 0
