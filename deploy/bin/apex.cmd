@echo off
REM =============================================================================
REM apex.cmd -- Apex Predator launcher for the JARVIS + Avengers stack.
REM The existing jarvis.cmd launches hermes-agent. This launcher points at our
REM deterministic risk-gate + Avengers fleet at C:\apex_predator\.
REM =============================================================================
setlocal
set "APEX_ROOT=C:\apex_predator"
set "APEX_PY=%APEX_ROOT%\.venv\Scripts\python.exe"
set "APEX_STATE=%LOCALAPPDATA%\apex_predator\state"
set "APEX_LOG=%LOCALAPPDATA%\apex_predator\logs"
