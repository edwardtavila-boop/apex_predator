"""
APEX PREDATOR  //  scripts.monthly_deep_review
==============================================
...
Usage
-----
    python -m apex_predator.scripts.monthly_deep_review \\
...
from apex_predator.backtest.exit_quality import (  # noqa: E402
    MaeMfePoint,
    analyze_batch,
    build_heatmap,
    money_left_on_table,
...
from apex_predator.brain.rationale_miner import (  # noqa: E402
    RationaleMiner,
    RationaleRecord,
    coverage,
)
from apex_predator.core.trade_grader import (  # noqa: E402
    ClosedTrade,
    grade_many,
    leak_distribution,
)
...
def _render_text(payload: dict) -> str:
    lines = [
        "=" * 72,
        f"APEX PREDATOR  //  MONTHLY DEEP REVIEW -- {payload['period']}",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="APEX PREDATOR monthly deep review",
    )
