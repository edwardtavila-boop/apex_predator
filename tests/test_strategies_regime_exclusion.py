"""APEX PREDATOR  //  tests.test_strategies_regime_exclusion.
...
Coverage:
  ...
  * ``_risk_mult`` in apex_policy zeroes for excluded regimes
...
from apex_predator.strategies import regime_exclusion as rex
from apex_predator.strategies.apex_policy import StrategyContext, _risk_mult
...
# ---------------------------------------------------------------------------
# Integration with apex_policy._risk_mult
# ---------------------------------------------------------------------------
