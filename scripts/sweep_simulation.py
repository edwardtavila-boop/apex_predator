"""
APEX PREDATOR  //  scripts.sweep_simulation
============================================
...
Usage
-----
    python -m apex_predator.scripts.sweep_simulation --start 27000 --weeks 12
    python -m apex_predator.scripts.sweep_simulation --start 50000 --weeks 26 \
...
def main() -> int:
    ...
    print("APEX PREDATOR -- Tier-A Sweep Simulation")
    print("=" * 100)
    print(
    ...
    # Tearsheet
    lines: list[str] = []
    lines.append("APEX PREDATOR -- Sweep Sim Tearsheet")
    lines.append("=" * 100)
    lines.append(
        f"Start: ${args.start:,.0f}   Weeks: {args.weeks}   "
        f"Allocations: MNQ={args.mnq_alloc*100:.0f}% "
