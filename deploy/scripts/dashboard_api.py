...
def _resolve_fleet_dir() -> Path | None:
    ...
    3. ``apex_predator`` subtrees under either ``STATE_DIR`` or
    ...
    candidates: list[Path] = [
        ...
        STATE_DIR.parent / "apex_predator" / "docs" / "btc_live" / "broker_fleet",
        Path.home() / "apex_predator" / "docs" / "btc_live" / "broker_fleet",
    ]
    try:
        from apex_predator.scripts.btc_broker_fleet import DEFAULT_OUT_DIR
