...
ASSIGNMENTS: tuple[StrategyAssignment, ...] = (
    ...
    # btc_hybrid — crypto_orb, production candidate, +2.46 OOS on walk-forward
    StrategyAssignment(
        bot_id="btc_hybrid",
        ...
        min_trades_per_window=10,
        strategy_kind="crypto_orb",
        rationale=("BTC hybrid — crypto_orb at 120m range. Walk-forward +2.46 OOS, 75% DSR pass."),
        extras={
            "promotion_status": "production",
            "walk_forward_overrides": {"long_haul_mode": True, "long_haul_min_pos_fraction": 0.38},
            "crypto_orb_config": {"range_minutes": 120, "atr_stop_mult": 3.0, "rr_target": 1.5},
            "daily_loss_limit_pct": 4.0,
            "warmup_policy": {"promoted_on": "2026-04-27", "warmup_days": 30, "risk_multiplier_during_warmup": 0.5},
        },
    ),
    # btc_regime_trend_etf — crypto_macro_confluence, research_candidate
    StrategyAssignment(
        ...
        rationale=("BTC regime trend + ETF flow. Walk-forward +4.28 OOS (original promotion)."),
        extras={
            "promotion_status": "research_candidate",
            "walk_forward_overrides": {"agg_degradation_mode": True, "long_haul_mode": True, "long_haul_min_pos_fraction": 0.38},
            "crypto_regime_trend_config": {"regime_ema": 100, "pullback_ema": 21, "pullback_tolerance_pct": 3.0, "atr_stop_mult": 2.0, "rr_target": 3.0},
            "macro_confluence_config": {"require_etf_flow_alignment": True},
            "daily_loss_limit_pct": 4.0,
            "warmup_policy": {"promoted_on": "2026-04-30", "warmup_days": 30, "risk_multiplier_during_warmup": 0.5},
        },
    ),
    # btc_ensemble_2of3 — ensemble_voting, production
    StrategyAssignment(
        ...
        rationale=("BTC ensemble voting — 2-of-3 vote across regime_trend, ETF, sage_daily. +5.95 OOS."),
        extras={
            "promotion_status": "production",
    ...
    # eth_perp — crypto_orb, production_candidate
    StrategyAssignment(
        bot_id="eth_perp",
        ...
        min_trades_per_window=3,
        strategy_kind="crypto_orb",
        rationale=("ETH perp — crypto_orb at 180m range. Walk-forward +1.93 OOS."),
        extras={
            "promotion_status": "production_candidate",
            "walk_forward_overrides": {"long_haul_mode": True, "long_haul_min_pos_fraction": 0.38},
            "crypto_orb_config": {"range_minutes": 180, "atr_stop_mult": 1.5, "rr_target": 1.0},
            "fleet_corr_partner": "btc_hybrid",
            "daily_loss_limit_pct": 4.0,
            "warmup_policy": {"promoted_on": "2026-04-29", "warmup_days": 30, "risk_multiplier_during_warmup": 0.5},
        },
    ),
    # btc_hybrid_sage — orb_sage_gated, research_candidate
    StrategyAssignment(
        ...
        min_trades_per_window=5,
        strategy_kind="orb_sage_gated",
        rationale=("BTC hybrid sage — sage-gated crypto_orb. Research candidate."),
        extras={
            "promotion_status": "research_candidate",
