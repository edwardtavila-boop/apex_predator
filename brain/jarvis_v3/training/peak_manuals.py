...
Each manual has:
  ...
  * doctrine      -- which Apex Predator tenets they most uphold
...
JARVIS = PeakManual(
    ...
    strengths=[
        ...
        "Apex Predator doctrine enforcement (7 tenets, priority ordered)",
    ...
    invocation="apex_predator.brain.jarvis_admin.JarvisAdmin.request_approval(req, ctx)",
)
