...
- `apex_predator/brain/htf_engine.py` — HTF composition logic.
- `apex_predator/brain/regime.py` — 5-axis classifier + drift detection.
- `apex_predator/brain/indicator_suite.py` — regime-weight table.
- `apex_predator/core/confluence_scorer.py` — score → leverage / signal.
- `apex_predator/bots/mnq/bot.py` — MNQ 4-setup engine (canonical ENGINE).
- `apex_predator/bots/eth_perp/bot.py` — CASINO-tier base (SOL/XRP inherit).
- `apex_predator/bots/crypto_seed/bot.py` — BTC grid + directional overlay.
- `apex_predator/core/risk_engine.py` — sizing, Kelly, drawdown kill.
